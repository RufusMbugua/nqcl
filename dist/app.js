...
angular.module('templates-dist', ['../app/partials/about/index.html',
	'../app/partials/admin/header.html', '../app/partials/admin/index.html',
	'../app/partials/admin/login.html',
	'../app/partials/articles/articles.add.html',
	'../app/partials/articles/articles.items.html',
	'../app/partials/articles/articles.items.widget.html',
	'../app/partials/articles/articles.list.html',
	'../app/partials/articles/articles.published.html',
	'../app/partials/articles/index.html',
	'../app/partials/contact/directions.html',
	'../app/partials/contact/email.html', '../app/partials/contact/index.html',
	'../app/partials/content/content.about.html',
	'../app/partials/content/content.detail.html',
	'../app/partials/content/content.header.html',
	'../app/partials/content/content.html',
	'../app/partials/content/content.main.html',
	'../app/partials/content/menu.html', '../app/partials/content/table.html',
	'../app/partials/files/add.html', '../app/partials/files/index.html',
	'../app/partials/files/list.html', '../app/partials/globals/carousel.html',
	'../app/partials/globals/secondary_header.html',
	'../app/partials/home/index.html', '../app/partials/home/main.html',
	'../app/partials/news/index.html', '../app/partials/public/header.html',
	'../app/partials/public/index.html', '../app/partials/services/index.html',
	'../app/partials/slides/add.html', '../app/partials/slides/index.html',
	'../app/partials/slides/list.html'
]);

angular.module("../app/partials/about/index.html", []).run(["$templateCache",
...
angular.module("../app/partials/admin/header.html", []).run(["$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/admin/index.html", []).run(["$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/admin/login.html", []).run(["$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/articles/articles.add.html", []).run([
	"$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/articles/articles.items.html", []).run([
	"$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/articles/articles.items.widget.html", []).run([
	"$templateCache",
	function($templateCache) {
		$templateCache.put("../app/partials/articles/articles.items.widget.html",
			...
			"\n" +
			"</div>\n" +
			"<a style=\"float:right\" href=\"\" class='btn btn-sm btn-view' ui-sref=\"public.news\"><i class='ion-more'></i>Read More</a>\n" +
			"<div ng-if=\"!content\">\n" +
			"  No articles for now.\n" +
			"</div>\n" +
			"");
...
angular.module("../app/partials/articles/articles.list.html", []).run([
	"$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/articles/articles.published.html", []).run([
	"$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/articles/index.html", []).run(["$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/contact/directions.html", []).run([
	"$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/contact/email.html", []).run(["$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/contact/index.html", []).run(["$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/content/content.about.html", []).run([
	"$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/content/content.detail.html", []).run([
	"$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/content/content.header.html", []).run([
	"$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/content/content.html", []).run([
	"$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/content/content.main.html", []).run([
	"$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/content/menu.html", []).run(["$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/content/table.html", []).run(["$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/files/add.html", []).run(["$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/files/index.html", []).run(["$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/files/list.html", []).run(["$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/globals/carousel.html", []).run([
	"$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/globals/secondary_header.html", []).run([
	"$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/home/index.html", []).run(["$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/home/main.html", []).run(["$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/news/index.html", []).run(["$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/public/header.html", []).run(["$templateCache",
	function($templateCache) {
		$templateCache.put("../app/partials/public/header.html",
			...
			"  </div>\n" +
			"  <div class=\"col-md-6\">\n" +
			"    <h3 style=\"text-align:center;margin-top:30px\">National Quality Control Lab for Drugs and Medical Devices</h3>\n" +
			"  </div>\n" +
			"  <div class=\"col-md-3\">\n" +
			"    <img id=\"nqcl-logo\" style=\"height:100px;padding-top:2%;margin-right: 25%\" class='img-responsive'src=\"app/images/logo/NQCL_logo.png\"/>\n" +
			"  </div>\n" +
			"</div>\n" +
			"\n" +
			"<nav id=\"main\">\n" +
...
angular.module("../app/partials/public/index.html", []).run(["$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/services/index.html", []).run(["$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/slides/add.html", []).run(["$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/slides/index.html", []).run(["$templateCache",
	function($templateCache) {
...
angular.module("../app/partials/slides/list.html", []).run(["$templateCache",
	function($templateCache) {
